function [ matches1, matches2 ] = sift_mosaic2(im1, im2)
...
run('D:/Documents/KinectFusion/utils/vlfeat/toolbox/vl_setup');
...
matches1 = [f1(1, matches(1, ok)); f1(2, matches(1, ok))];
matches2 = [f2(1, matches(2, ok)); f2(2, matches(2, ok))];
