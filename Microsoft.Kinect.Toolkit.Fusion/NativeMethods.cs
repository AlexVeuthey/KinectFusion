...
namespace Microsoft.Kinect.Toolkit.Fusion
{
    ...
    internal interface INuiFusionReconstruction
    {
        ...
        HRESULT DepthToDepthFloatFrame(
            [In, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I1, SizeParamIndex = 1)] DepthImagePixel[] depthImageData,
    ...
    internal static class NativeMethods
    {
        ...
        {
            get { return sizeof(int) == IntPtr.Size ? "KinectFusion180_32.dll" : "KinectFusion180_64.dll"; }
        }
