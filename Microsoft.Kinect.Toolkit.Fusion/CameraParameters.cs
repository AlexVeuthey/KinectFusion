...
namespace Microsoft.Kinect.Toolkit.Fusion
{
    ...
    public class CameraParameters : IEquatable<CameraParameters>
    {
        ...
        /// </summary>
        private const float CameraDepthNominalFocalLengthInPixels = 285.63f;

        /// <summary>
        /// The x value of the default normalized focal length.
        /// </summary>
        private const float DepthNormFocalLengthX = CameraDepthNominalFocalLengthInPixels / 320.0f;

        /// <summary>
        /// The y value of the default normalized focal length.
        /// </summary>
        private const float DepthNormFocalLengthY = CameraDepthNominalFocalLengthInPixels / 240.0f;

        /// <summary>
        /// The x value of the depth normalized principal point.
        /// </summary>
        private const float DepthNormPrincipalPointX = 0.5f;

        /// <summary>
        /// The y value of the depth normalized principal point.
        /// </summary>
        private const float DepthNormPrincipalPointY = 0.5f;
        ...
        public CameraParameters(KinectSensor sensor)
        {
            if (null == sensor)
            {
            ...
            this.FocalLengthX = sensor.DepthStream.NominalFocalLengthInPixels;
            this.FocalLengthY = FocalLengthX / 480.0f * 640.0f;    // same 1.33:1 ratio for all Kinect resolutions
            this.PrincipalPointX = 0.5f;
            this.PrincipalPointY = 0.5f;
        }
